...
## ABOUT DATASET
This dataset gives information related to heart disease. The dataset contains 14 columns, target is the class variable which is affected by the other 13 columns. Here the aim is to classify the target variable to (disease\non disease) using different machine learning algorithms and find out which algorithm is suitable for this dataset.
